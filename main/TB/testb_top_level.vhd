...
begin
  ...
  begin
    ...
    report "Fed " & integer'image(bits_fed) & " bits total" severity note;
  ...
  begin
    ...
    -- Count outputs (skip the first one which is the base/warm-up)
    loop
      wait until rising_edge(clk_i);
      ...
      if vld_o = '1' then
        ...
        -- After receiving all outputs (1 skipped + 8 actual = 9 total)
