...
input_integers = data[:100]   # or data for all
...
probabilities = [p_0_source, p_1_source]
source_entropy_bits = entropy(probabilities, base=2)

print("\n--- Source Entropy Result ---")
print(f"Shannon Source Entropy (H): {source_entropy_bits:.4f} bits/bit")
