...
begin
    ...
    begin
        ...
        -- CLK Cycle 4: Current In (30), Prev Word (20). Delta = 30 - 20 = 10
        data_streamin_s <= 30; -- Decimal 30
        -- data_out should be "00001010" (10)
        -- shift_reg(23 downto 16) should be "00001010"
        wait for CLK_PERIOD;
        
        -- CLK Cycle 5: Current In (0), Prev Word (30). Delta = 0 - 30 = -30
        data_streamin_s <= 0; -- Decimal 0
        -- data_out should be "11100010" (-30)
        -- shift_reg(7 downto 0) should be "11100010"
        wait for CLK_PERIOD;
